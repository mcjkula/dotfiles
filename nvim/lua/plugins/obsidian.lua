return {
	...
	opts = {
		workspaces = {
			{
				name = "Notes",
				path = "/Users/maciej/Library/Group Containers/G69SCX94XU.duck/Library/Application Support/duck/Volumes.noindex/Nextcloud/documents/obsidian",
			},
		},
		...
		-- Optional, by default when you use `:ObsidianFollowLink` on a link to an external URL it will be ignored but you can customize this behavior here.
